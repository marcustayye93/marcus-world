    ...
    details: [
      {
        ...
        period: "2024 – Present",
        bullets: [
          "Managing the top 1% of clients across Australia and New Zealand, spanning 25+ business verticals",
          "Drove US$684K incremental ad spend for SABI Group by scaling daily budget from US$8K to US$30K — a 280% uplift in 32 days",
          "Shifted Great Southern Bank's digital budget from Google to Meta, unlocking US$94K incremental spend",
          "Facilitated market expansion tests for Cheekywinx across 4 new markets, leading to US expansion in 2026",
          "Influenced multi-department ad strategy at Channel Seven through product training and strategic workshops",
          "Achieved highest CSAT score in APAC — 100/100 — and awarded 2025 Client Hero (Infinite Potential Award)",
          "Revenue attainment: Q2 111%, Q3 109%, Q4 109% — hit 100% of all DCMP metrics in H2",
          "Contributed to Activate 2 Pod through strategy sharing, enablement materials, and team culture initiatives",
        ],
      },
    ],
  },
