...
export const EASTER_EGGS = {
  ...
  musicNotes: ["♪", "♫", "♬", "♩", "♭", "♮"],
  punnyDialogues: [
    // Navigation hints first
    "Welcome! Click on any building to explore a chapter of Marcus's journey!",
    "See that grand Emerald City in the center? That's where the Meta magic happens! Click it to explore.",
    ...
    "Fun fact: Marcus once performed clarinet for Singapore's Prime Minister.",
    "Fun fact: He once got robbed in Marrakech, but got out of it by befriending his robbers.",
    "Fun fact: He stayed in a haunted house in rural China on an earthquake relief mission.",
    "Fun fact: He really enjoys the comedy of Conan O'Brien.",
    "Fun fact: He's been trying to learn the accordion, but it's never been able to stick.",
    "Fun fact: He lived two years in Hong Kong, eight months in Germany, and six months in Finland.",
    "Fun fact: He shepherded 70 animals across 2 farms in New Zealand.",
    "Fun fact: He launched a coffee enterprise with 80 student baristas.",
    "Fun fact: He plays 5 musical instruments and was a DJ.",
    "Fun fact: He used to have long curly hair down to his shoulders.",
    "Fun fact: He is the biggest John Mayer fan. John Mayer was his inspiration when learning guitar.",
    "Fun fact: He knows every line from every episode of The Office (US). Take him to a pub quiz!",
    "Fun fact: He's trying to pick up running, but is failing spectacularly. Half marathon one day!",
    "Fun fact: He speaks three languages: English, Chinese/Mandarin, and Cantonese.",
    "Fun fact: He traveled to Yun Nan, China for 5 weeks of earthquake disaster relief.",
  ],
};
