...
export const ZONES: Zone[] = [
  {
    ...
    name: "Meta HQ",
    icon: "💼",
    tagline: "Managing the top 1% of clients in ANZ — 2025 Client Hero",
  ...
  },
  {
    ...
    name: "DFS Group",
    icon: "🏢",
    tagline: "4 promotions in 5 years — from beauty counters to global IT",
    description: "A rapid internal promotion journey through luxury retail — from managing 43 beauty brands to orchestrating technology rollouts across 6 countries.",
