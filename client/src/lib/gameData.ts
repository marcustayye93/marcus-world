...
export const EASTER_EGGS = {
  ...
  punnyDialogues: [
    ...
    "He once got robbed in Marrakech, but got out of it by befriending his robbers.",
    ...
    "He stayed in a haunted house in rural China on an earthquake relief mission.",
    ...
    "He used to have long curly hair down to his shoulders.",
    ...
    "He is the biggest John Mayer fan. John Mayer was his inspiration when learning guitar.",
    "He knows every line from every episode of The Office (US). Take him to a pub quiz!",
    "He plays 5 musical instruments and was a DJ.",
    "Check out Testimonials to hear what colleagues and managers have to say!",
    "He's trying to pick up running, but is failing spectacularly. Half marathon one day!",
